    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav nav ml-auto">
          ...
          <li class="nav-item"><a href="index.php#services-section" class="nav-link"><span>Services</span></a>
          </li>
          <li class="nav-item"><a href="index.php#projects-section" class="nav-link"><span>Projects</span></a>
          </li>
          <li class="nav-item"><a href="index.php#about-section" class="nav-link"><span>About</span></a></li>
          <li class="nav-item"><a href="index.php#testimony-section" class="nav-link"><span>Testimony</span></a>
          </li>
        ...
        <div class="col-lg-8 ftco-animate">
          ...
          <p>
            <script data-pagespeed-no-defer>//<![CDATA[
              ...
              pagespeed.CriticalImages.Run('/mod_pagespeed_beacon', 'single.php', '-ilGEe-FWC', true, false, '7LY8zgWjxNs');
//]]></script><img src="images/ximage_3.jpg.pagespeed.ic.trchucgaea.jpg" alt="" class="img-fluid"
              data-pagespeed-url-hash="1594264175" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          </p>
          ...
          <p>
            <img src="images/ximage_4.jpg.pagespeed.ic.9_smiaagnb.jpg" alt="" class="img-fluid"
              data-pagespeed-url-hash="1888764096" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          </p>
          ...
          <div class="about-author d-flex p-4 bg-light">
            <div class="bio mr-5">
              <img src="images/xperson_1.jpg.pagespeed.ic.p4phl6glbj.jpg" alt="Image placeholder" class="img-fluid mb-4"
                data-pagespeed-url-hash="2802530901" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
            </div>
            <div class="desc">
              ...
              <li class="comment">
                <div class="vcard bio">
                  <img src="images/xperson_1.jpg.pagespeed.ic.p4phl6glbj.jpg" alt="Image placeholder"
                    data-pagespeed-url-hash="2802530901"
          ...
          <div class="sidebar-box ftco-animate">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4"
                style="background-image:url(images/ximage_1.jpg.pagespeed.ic.vf_don1zsh.jpg)"></a>
              <div class="text">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4"
                style="background-image:url(images/ximage_2.jpg.pagespeed.ic.mmfqd6zg2h.jpg)"></a>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a>
                </h3>
                <div class="meta">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4"
                style="background-image:url(images/ximage_3.jpg.pagespeed.ic.trchucgaea.jpg)"></a>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a>
                </h3>
                <div class="meta">
  ...
  <script src="script/script_four.js"></script>
  ...
  <script src="script/script_five.js"></script>
  ...
  <script src="script/script_six.js"></script>
  ...
  <script defer src="js/beacon.min.js"
    data-cf-beacon='{"rayId":"680c001f8dbbfe02","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.8.1","si":10}'></script>
</body>
